...
object VectorLocale {
    ...
    fun init(context: Context) {
        ...
        if (preferences.contains(APPLICATION_LOCALE_LANGUAGE_KEY)) {
            ...
            val defaultStringValue = getString(
                context,
                defaultLocale,
                R.string.resources_country_code
            )
            if (TextUtils.equals(defaultStringValue,
                    getString(
                        context,
                        applicationLocale,
                        R.string.resources_country_code
    ...
    private fun initApplicationLocales(context: Context) {
        ...
        supportedLocales.sortWith(Comparator { lhs, rhs -> localeToLocalisedString(
            lhs
        ).compareTo(localeToLocalisedString(rhs)) })
    }
