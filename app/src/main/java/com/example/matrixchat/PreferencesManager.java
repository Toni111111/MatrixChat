...
public class PreferencesManager {
    ...
    public static void clearPreferences(Context context) {
        ...
        // home server urls
    //todo    keysToKeep.add(ServerUrlsRepository.HOME_SERVER_URL_PREF);
        //todo     keysToKeep.add(ServerUrlsRepository.IDENTITY_SERVER_URL_PREF);

        // theme
        //todo    keysToKeep.add(ThemeUtils.APPLICATION_THEME_KEY);
